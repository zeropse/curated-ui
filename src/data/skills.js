export const skills = [
  ...
  },
  {
    ...
    category: "Coding Guidelines",
    description:
      "Enforce zero 'any' policy, exhaustive union checks, type narrowing, and resilient API contract typing.",
    source: "community/typescript-skills",
    copyCommand: "npx skills add community/typescript-skills",
  },
  {
    ...
    category: "Coding Guidelines",
    description:
      "Runtime schema validation, environment variable checking, API input sanitization, and type inference.",
    source: "community/zod-skills",
    copyCommand: "npx skills add community/zod-skills",
  },
  {
    ...
    description:
      "End-to-end user flow testing, visual regression checks, page object models, and CI integration.",
    source: "microsoft/playwright-skills",
    copyCommand: "npx skills add microsoft/playwright-skills",
  },
];
